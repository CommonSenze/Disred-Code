...
public class GamemodeCCommand extends Executor {

	public GamemodeCCommand(String command, String description, String...aliases) {
	...
	public ArrayList<String> getHelp(Player player) {
		return new ArrayList<>(Arrays.asList(
				(player.hasPermission(getPermission()) ? ServerColor.PRIMARY + "/"+getName()+" - "+ServerColor.SECONDARY+"Set you gamemode to creative.": ""),
				(player.hasPermission(getPermission()) ? ServerColor.PRIMARY + "/"+getName()+" <player> - "+ServerColor.SECONDARY+"Set you gamemode to creative for <player>.": "")
				));
	}
}
