...
package me.commonsenze.wrapper.Packets;
...
public class WrapperPlayServerBed extends AbstractPacket {
    ...
    */
    public Entity getEntity() {
        return handle.getEntityModifier(this.world).read(0);
    }
    ...
    */
    public void setEntity(Entity entity) {
        ...
        handle.getEntityModifier(this.world).write(0, entity);
    }
    ...
    */
    public int getX() {
        return handle.getSpecificModifier(int.class).read(1);
    }
    ...
    */
    public void setX(int value) {
        handle.getSpecificModifier(int.class).write(1, value);
    }
    ...
    */
    public byte getY() {
        return handle.getSpecificModifier(int.class).read(2).byteValue();
    }
    ...
    */
    public void setY(byte value) {
        handle.getSpecificModifier(int.class).write(2, (int) value);
    }
    ...
    */
    public int getZ() {
        return handle.getSpecificModifier(int.class).read(3);
    }
    ...
    */
    public void setZ(int value) {
        handle.getSpecificModifier(int.class).write(3, value);
    }
